...
describe("Test for notifications.js", () => {
  ...
  it("verify that normalizedDatad data has a correct users entity", () => {
    const expectedUser = {
      age: 25,
  ...
  it("verify that the normalizedDatad data has a correct messages entity", () => {
  ...
  it("verify that the normalizedDatad data has a correct notifications entity", () => {
